...
const TString OUT    = "/home/lins/u3_PIDQuantify/figures/final_calibration/2d_differences/combined20";
const TString CUT    = "DLLp-DLLK>20.0";
...
void perf_finals_2d_combined20(){
    gStyle->SetOptStat(0);
